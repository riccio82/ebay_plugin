...
class ReviewSidePanel extends React.Component{
    ...
    componentDidMount() {
        ...
        SegmentStore.addListener('ADD_SEGMENT_VERSIONS_ISSUES', this.segmentOpened.bind(this));
    ...
    componentWillUnmount() {
        ...
        SegmentStore.removeListener('ADD_SEGMENT_VERSIONS_ISSUES', this.segmentOpened);
